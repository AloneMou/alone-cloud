...
import com.alone.coder.framework.redis.core.job.RedisPendingMessageResendJob;
import com.alone.coder.framework.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.alone.coder.framework.redis.core.stream.AbstractRedisStreamMessageListener;
...
@AutoConfiguration(after = AloneRedisAutoConfiguration.class)
public class AloneRedisMQConsumerAutoConfiguration {
    ...
    private static void checkRedisVersion(RedisTemplate<String, ?> redisTemplate) {
        ...
        if (majorVersion < 5) {
            throw new IllegalStateException("您当前的 Redis 版本为 {}，小于最低要求的 5.0.0 版本！");
        }
    }
