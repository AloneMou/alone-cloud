package com.alone.coder.framework.tracer.config;

import com.alone.coder.framework.common.enums.WebFilterOrderEnum;
import com.alone.coder.framework.tracer.core.aop.BizTraceAspect;
import com.alone.coder.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "alone.tracer", value = "enable", matchIfMissing = true)
public class AloneTracerAutoConfiguration {
