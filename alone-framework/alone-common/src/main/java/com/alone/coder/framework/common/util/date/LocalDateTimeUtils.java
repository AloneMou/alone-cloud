package com.alone.coder.framework.common.util.date;
...
import com.alone.coder.framework.common.enums.DateIntervalEnum;
...
public class LocalDateTimeUtils {
	 ...
	 */
	public static boolean isOverlap(LocalTime startTime1, LocalTime endTime1, LocalTime startTime2,
			LocalTime endTime2) {
		LocalDate nowDate = LocalDate.now();
	...
	public static List<LocalDateTime[]> getDateRangeList(LocalDateTime startTime, LocalDateTime endTime,
			Integer interval) {
		// 1.1 找到枚举
		...
		switch (intervalEnum) {
			...
			case YEAR:
				while (startTime.isBefore(endTime)) {
					LocalDateTime endOfYear = startTime.with(TemporalAdjusters.lastDayOfYear())
						.plusDays(1)
						.minusNanos(1);
