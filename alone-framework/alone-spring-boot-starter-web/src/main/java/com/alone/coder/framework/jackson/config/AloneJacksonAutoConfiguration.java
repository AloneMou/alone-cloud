package com.alone.coder.framework.jackson.config;

import com.alone.coder.framework.common.util.json.JsonUtils;
import com.alone.coder.framework.common.util.json.databind.NumberSerializer;
import com.alone.coder.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.alone.coder.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class AloneJacksonAutoConfiguration {
