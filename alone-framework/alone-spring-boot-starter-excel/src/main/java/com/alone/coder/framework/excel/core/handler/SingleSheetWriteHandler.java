...
import com.alone.coder.framework.excel.core.error.code.ExcelErrorCode;
...
import static com.alone.coder.framework.excel.core.error.code.ExcelErrorCode.EXCEL_RETURN_TYPE_ERROR;
...
public class SingleSheetWriteHandler extends AbstractSheetWriteHandler {
	...
	public boolean support(Object obj) {
		if (obj instanceof List) {
			...
			throw new ServiceException(EXCEL_RETURN_TYPE_ERROR);
		}
	}
