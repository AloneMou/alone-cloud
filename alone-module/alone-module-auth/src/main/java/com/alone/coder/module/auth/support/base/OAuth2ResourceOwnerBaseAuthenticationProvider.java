package com.alone.coder.module.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.alone.coder.framework.security.core.service.AloneRedisOAuth2AuthorizationService;
...
import static com.alone.coder.framework.common.constant.SecurityConstants.ONLINE_QUANTITY;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
     ...
     * @return <code>true</code> if the implementation can process the authentication request,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            AloneRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (AloneRedisOAuth2AuthorizationService) this.authorizationService;
