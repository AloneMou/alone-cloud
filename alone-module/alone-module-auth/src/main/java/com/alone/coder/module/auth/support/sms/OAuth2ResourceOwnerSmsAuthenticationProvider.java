...
import com.alone.coder.module.auth.support.base.OAuth2ResourceOwnerBaseAuthenticationProvider;
...
public class OAuth2ResourceOwnerSmsAuthenticationProvider
	...
	public void checkClient(RegisteredClient registeredClient) {
		...
		if (!registeredClient.getAuthorizationGrantTypes()
			.contains(new AuthorizationGrantType(GrantTypeEnums.SMS.getType()))) {
	...
	public UsernamePasswordAuthenticationToken buildToken(Map<String, Object> reqParameters) {
		String phone = (String) reqParameters.get(SMS_PARAMETER_NAME);
